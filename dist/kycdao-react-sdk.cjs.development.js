...
var KycDaoContext = /*#__PURE__*/React.createContext({
  kycDao: null
});

var useKycDao = function useKycDao() {
  var context = React.useContext(KycDaoContext);

  if (context === undefined) {
    throw new Error("useKycDao must be used within a KycDaoProvider");
  }

  var kycDao = context.kycDao;
  return kycDao;
};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return new Promise(function (resolve) { resolve(_interopNamespace(require('@kycdao/kycdao-sdk'))); });
...
var KycDaoProvider = function KycDaoProvider(_ref) {
  var children = _ref.children,
      _ref$networkId = _ref.networkId,
      networkId = _ref$networkId === void 0 ? 'testnet' : _ref$networkId,
      config = _ref.config;

  var _useState = React.useState(null),
      kycDao = _useState[0],
      setKycDao = _useState[1];

  React.useEffect(function () {
    var initKycDao = /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var _yield$import, KycDao, defaultConfig, kycDaoInitialized;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                ...
                _context.next = 9;
                return KycDao.initialize(_extends({}, defaultConfig, config));

              case 9:
                kycDaoInitialized = _context.sent;
  ...
  return React__default.createElement(KycDaoContext.Provider, {
    value: contextValue
  }, children);
};

exports.KycDaoContext = KycDaoContext;
exports.KycDaoProvider = KycDaoProvider;
exports.useKycDao = useKycDao;
//# sourceMappingURL=kycdao-react-sdk.cjs.development.js.map
